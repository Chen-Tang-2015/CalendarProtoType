...
namespace CalendarWebAppPrototype
{
                ...
                new OpenIdConnectAuthenticationOptions
                {
                    ...
                    Notifications = new OpenIdConnectAuthenticationNotifications()
                    {
                        ...
                        AuthorizationCodeReceived = (context) =>
                        {
                            ...
                            string singInUserId = context.AuthenticationTicket.Identity.FindFirst(ClaimTypes.NameIdentifier).Value;

                            AuthenticationContext authContext = new AuthenticationContext(string.Format("{0}/{1}", SettingsHelper.AuthorizationUri, tenantID), new ADALTokenCache(singInUserId));
                            ...
                            AuthenticationResult result = authContext.AcquireTokenByAuthorizationCode(code,
                                ...
                                credential,
                                SettingsHelper.GraphResourceId);
