...
namespace CalendarWebAppPrototype.Utils
{
    public class SettingsHelper
    {
        ...
        private static string _appKey = ConfigurationManager.AppSettings["ida:AppKey"] ?? ConfigurationManager.AppSettings["ida:Password"] ?? ConfigurationManager.AppSettings["ida:ClientSecret"];
        ...
        private static string _graphResourceUri = "https://graph.microsoft.com/beta/";
        ...
        private static string _outlookResourceUri = "https://outlook.office365.com/v1.0/me/";
        ...
        public static string OutlookResourceUri
        {
            get
            {
                return _outlookResourceUri;
            }
        }
    }
}
